...
###############################################
# path: server
analysis_result_path='/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/analysis_result/'
detail_input_path='/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/velocity_result/celldancer/'
raw_input_path='/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/raw/'
scv_result_input_path='/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/velocity_result/scv/'
...
# raw_input_path='/condo/wanglab/tmhsxl98/Velocity/simulation_velocity_analysis/simulation_data/raw/wingpath/'
# scv_result_input_path='/condo/wanglab/tmhsxl98/Velocity/simulation_velocity_analysis/simulation_data/velocity_result/scv/'

# # path - shengyu
# detail_input_path='/Users/shengyuli/Library/CloudStorage/OneDrive-HoustonMethodist/work/Velocity/data/simulation/data/wing_path/wing_path_20220218/velocity_result/celldancer/'
# raw_input_path='/Users/shengyuli/Library/CloudStorage/OneDrive-HoustonMethodist/work/Velocity/data/simulation/data/wing_path/wing_path_20220218/raw/'
# scv_result_input_path='/Users/shengyuli/Library/CloudStorage/OneDrive-HoustonMethodist/work/Velocity/data/simulation/data/wing_path/wing_path_20220218/velocity_result/scv/'
# analysis_result_path='/Users/shengyuli/Library/CloudStorage/OneDrive-HoustonMethodist/work/Velocity/data/simulation/data/wing_path/wing_path_20220218/analysis_result'
...
for ratio in ratio_list:
    scv_cell=pd.read_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/analysis_result/scvelo_similarity_eachCell'+str(ratio)+'.csv')
    scv_cell=scv_cell.rename(columns={"Unnamed: 0": "cellID", "cell": "gene"})
    scv_cell.to_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/analysis_result/scvelo_similarity_eachCell'+str(ratio)+'.csv',index=False)

########## celldancer correct col name
ratio_list=[0.8,0.6,0.4,0.2]
# ratio_list=[1]
for ratio in ratio_list:
    scv_cell=pd.read_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/analysis_result/celldancer_similarity_eachCell'+str(ratio)+'.csv')
    scv_cell=scv_cell.rename(columns={"Unnamed: 0": "cellID", "cell": "gene"})
    scv_cell.to_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/analysis_result/celldancer_similarity_eachCell'+str(ratio)+'.csv',index=False)
###############################################
...
for sim_cutoff in sim_cutoff_list:
    ...
    for ratio in ratio_list:
        ...
        #celldancer
        print('celldancer')
        celldancer_cell=pd.read_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/analysis_result/celldancer_similarity_eachCell'+str(ratio)+'.csv')
    ...
    combined_error_df.to_csv(('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/analysis_result/'+'error_sim'+str(sim_cutoff)+'.csv'),index=False)
    # plt.figure()
...
###################################################
#### several samples for wingpath  ###############
###################################################

import pandas as pd
from velocity_plot import velocity_plot as vpl
scv_result=pd.read_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/velocity_result/scv/scvelo_result_wing_path__s0_u0_s1_u1_dynamic_and_steady_df_1.csv')
celldancer_result=pd.read_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/velocity_result/celldancer/ratio1_all_geneepoch200check_nNoneLr0.001C2cf0.3Downneighbors0_200_200Ratio0.125N30OAdamtraceR0.0corrcoefR0.0/detail_e200.csv')
...
path='/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/wing_path/wing_path_20220218/velocity_result/compare_gene_velocity_figures/'
gene_list=[0,4,7,14,36,38,42,85,86,90,97,136]
for i in gene_list:
...
###################################################
#### end - several samples for wingpath  #########
###################################################
