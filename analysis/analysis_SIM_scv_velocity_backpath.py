...
def pipline_run_sim_data(load_raw_data,name,ratio):
    ...
    s0_mat.to_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/back_path/back_path_20220222/build_scv_compatible_raw/s0_'+ratio+'.csv')
    u0_mat.to_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/back_path/back_path_20220222/build_scv_compatible_raw/u0_'+ratio+'.csv')

    s0_mat=pd.read_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/back_path/back_path_20220222/build_scv_compatible_raw/s0_'+ratio+'.csv')
    u0_mat=pd.read_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/back_path/back_path_20220222/build_scv_compatible_raw/u0_'+ratio+'.csv')

    adata_building=sc.read_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/back_path/back_path_20220222/build_scv_compatible_raw/s0_'+ratio+'.csv', delimiter=',', first_column_names=True, dtype='float32')
    ...
    adata_building_test.write(filename='/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/back_path/back_path_20220222/build_scv_compatible_raw/backpath_'+ratio+'.h5ad')

    # gene velocity plot
    gene_choice=load_raw_data['gene_list'].drop_duplicates()
    # gene_choice=['simulation0','simulation1']

    outpath='/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/back_path/back_path_20220222/velocity_result/scv'
    ...
    gene_s0_u0_s1_u1_dynamic_and_steady_df.to_csv(os.path.join(outpath,'scvelo_result_back_path__s0_u0_s1_u1_dynamic_and_steady_df_'+ratio+'.csv'),index=False)
...
if __name__ == "__main__":
    ...
    for ratio in ratio_list:
        print(ratio)
        ratio=str(ratio)
        load_raw_data=pd.read_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/back_path/back_path_20220222/raw/back_path_Path1Upper_1000__R'+ratio+'.csv')
    ...
    # scv_result=pd.read_csv('/Users/wanglab/Documents/ShengyuLi/Velocity/data/simulation/data/back_path/back_path_20220222/velocity_result/scv/scvelo_result_back_path__s0_u0_s1_u1_dynamic_and_steady_df_0.2.csv')    
