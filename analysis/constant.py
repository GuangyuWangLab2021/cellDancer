...
def select_gene_set(data_source):
    if data_source=="scv":
        ...
        gene_choice=['Rimbp2','Dctn3','Psd3','Dcx','Elavl4','Ntrk2','Nav1']
        # gene_choice=['Rimbp2','Dctn3','Psd3','Dcx','Elavl4','Ntrk2','Pfkp','Gnao1','Ncald','Klf7','Nav1','Gpc6']
    elif data_source=='test':
        gene_choice=['simulation0']
    elif data_source=='test_2gene':
        gene_choice=['Nav1']
        # gene_choice=['Nav1','Dcx','Elavl4','Ntrk2']
