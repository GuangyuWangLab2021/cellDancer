...
if __name__ == "__main__":
    ...
    #forward
    data = generate_forward(gene_num=6, alpha=15, beta=10, gamma=12, sample=1000, noise_level=0.2)
    ...
    #multiple path
    data = generate_multipath(gene_num=6, alpha1=15, alpha2=30, beta1=10, beta2=10, gamma1=12, gamma2=12, path1_pct=99, path2_pct=75, path1_sample=1000, path2_sample=1000, noise_level=0.2)
    data_g1 = data[data['gene_list']=="simulation000"]
    plt.scatter(data_g1['s0'], data_g1['u0'], c=data_g1['alpha'], s=1)
    plt.show()
    ...
    #########################################################
    # Simulation with dataframe.  This is for situation with multiple sections
    ...
    ###########################################
    # Simulation with different alpha, beta, gamma in each cell
    data = generate_onepath(gene_num=6, alpha1=15, alpha2=0, beta1=10, beta2=3, gamma1=12, gamma2=4, path1_pct=99, path2_pct=99, path1_sample=1000, path2_sample=1000, noise_level=0.2)
    data_g1 = data[data['gene_list']=="simulation000"]
    ...
    # Relationship betweeen t, alpha, beta, gamma, s, u
