...
def training_realdata_figure1b():
    ...
    detail_e210.to_csv("output/detailcsv/adj_e/detail_e210.csv")
    detail_e225.to_csv("output/detailcsv/adj_e/detail_e225.csv")
    detail_e250.to_csv("output/detailcsv/adj_e/detail_e250.csv")
    detail_e275.to_csv("output/detailcsv/adj_e/detail_e275.csv")
