...
#    embedding = load_raw_data[load_raw_data.gene_list.isin(\
#        load_raw_data.gene_list[0].drop_duplicates().to_list())][['embedding1', 'embedding2']].to_numpy()
