...
auto_downsample=bool(sys.argv[21])
auto_norm_u_s=bool(sys.argv[22])

startpoint=int(sys.argv[23])
endpoint=int(sys.argv[24])
...
folder_name=(task_id + data_source+
    ...
    "N"+str(n_neighbors)+
    "O"+optimizer+
    "traceR"+str(trace_cost_ratio)+"corrcoefR"+str(corrcoef_cost_ratio))
